...
async function main() {
  ...
  const leadData = [
    { partner_id: p1.id, client_name: 'Michael & Emma Thompson', current_address: '45 Oak Avenue, London, SW12 8TH', destination_address: 'KT2 6QH', contact_number: '07700 900123', email: 'thompson@email.com', estimated_moving_date: '2024-05-15', property_size: '3-bed', notes: 'Large family move, some garden furniture', move_stage: 'Exchanged', status: 'Survey Booked', commission_rate: 10, quote_value: 1850 },
    { partner_id: p1.id, client_name: 'David Harris', current_address: '12 Rose Street, London, SE5 9BG', destination_address: 'RH1 1AA', contact_number: '07700 900456', email: 'david.harris@email.com', estimated_moving_date: '2024-06-01', property_size: '1-bed', notes: 'Studio flat contents only', move_stage: 'Offer accepted', status: 'Contacted', commission_rate: 10 },
    { partner_id: p1.id, client_name: 'The Patel Family', current_address: '78 Elm Road, London, N4 2HQ', destination_address: 'HA2 7NW', contact_number: '07700 900789', email: 'patel.family@email.com', estimated_moving_date: '2024-04-20', property_size: '4-bed', notes: 'Piano included – needs specialist handling', move_stage: 'Ready to move', status: 'Job Completed', commission_rate: 10, quote_value: 2800 },
    { partner_id: p1.id, client_name: 'Sophie Williams', current_address: '23 Maple Close, London, E3 4QP', destination_address: 'CM1 1BE', contact_number: '07700 900321', email: 'sophie.w@email.com', estimated_moving_date: '2024-04-10', property_size: '2-bed', move_stage: 'Ready to move', status: 'Commission Paid', commission_rate: 10, quote_value: 1200, commission_paid: true },
    { partner_id: p1.id, client_name: 'Robert & Lisa Clarke', current_address: '99 Cedar Street, London, N16 7XP', destination_address: 'GU1 4AQ', contact_number: '07700 900654', email: 'clarkes@email.com', estimated_moving_date: '2024-07-20', property_size: '5-bed', notes: 'High-value property, fragile antiques', move_stage: 'Exchanged', status: 'Quoted', commission_rate: 10, quote_value: 4200 },
    { partner_id: p2.id, client_name: 'James Carter', current_address: '99 Birch Lane, London, W3 8RT', destination_address: 'OX1 1BP', contact_number: '07700 901234', email: 'james.carter@email.com', estimated_moving_date: '2024-07-01', property_size: '3-bed', notes: 'Has a storage unit too', move_stage: 'Offer accepted', status: 'New Lead', commission_rate: 10 },
    { partner_id: p2.id, client_name: 'Amanda Foster', current_address: '14 Willow Way, London, SE22 9LN', destination_address: 'BN1 1JH', contact_number: '07700 901567', email: 'amanda.foster@email.com', estimated_moving_date: '2024-06-15', property_size: '2-bed', move_stage: 'Just listed', status: 'Contacted', commission_rate: 10 },
    { partner_id: p2.id, client_name: 'George & Helen Marsh', current_address: '7 Acacia Drive, London, SW4 7GH', destination_address: 'BS1 4ST', contact_number: '07700 901890', email: 'marsh.family@email.com', estimated_moving_date: '2024-05-28', property_size: '4-bed', notes: 'Antique furniture, needs extra care', move_stage: 'Ready to move', status: 'Quote Accepted', commission_rate: 12, quote_value: 3100 },
  ];
